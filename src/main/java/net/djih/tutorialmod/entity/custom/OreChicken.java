...
public class OreChicken extends Animal {

    private static Item laidRessource = Items.EGG;
    ...
    public OreChicken(EntityType<? extends Animal> entityType, Level level) {
        super(entityType, level);
    }

    public static AttributeSupplier.Builder getOreChickenAttributes(){
        return Mob.createMobAttributes()
                .add(ForgeMod.ENTITY_GRAVITY.get(),1.2f)
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.ORE_CHICKEN.get().create(level);
    }
